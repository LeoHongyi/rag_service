...
class Settings(BaseSettings):
    ...
    # [ App ] rag
    ##################################################
    RAG_STORAGE_PROVIDER: Literal['local', 's3'] = 'local'
    RAG_STORAGE_LOCAL_PATH: str = './data/rag-objects'
    RAG_STORAGE_ENDPOINT: str | None = None
    RAG_STORAGE_BUCKET: str = 'rag-documents'
    RAG_STORAGE_ACCESS_KEY: str | None = None
    RAG_STORAGE_SECRET_KEY: str | None = None
    RAG_STORAGE_REGION: str = 'us-east-1'
    ...
    RAG_PDF_MAX_TEXT_CHARS: int = 1_000_000
    RAG_RETRIEVAL_TOP_K: int = 5
    RAG_RETRIEVAL_MIN_SCORE: float = 0.25
    RAG_DENSE_CANDIDATE_K: int = 30
    RAG_LEXICAL_CANDIDATE_K: int = 30
    RAG_RRF_K: int = 60
    RAG_DENSE_RRF_WEIGHT: float = 1.0
    RAG_LEXICAL_RRF_WEIGHT: float = 0.5
    RAG_PARENT_CONTEXT_ENABLED: bool = False
    RAG_RERANK_ENABLED: bool = False
    RAG_RERANK_PROTOCOL: Literal['openai', 'dashscope'] = 'openai'
    RAG_RERANK_BASE_URL: str | None = None
    RAG_RERANK_API_KEY: str | None = None
    RAG_RERANK_MODEL: str | None = None
    RAG_RERANK_TOP_N: int = 20
    RAG_RERANK_TIMEOUT_SECONDS: float = 5.0
    RAG_RERANK_INPUT_PRICE_PER_MILLION_TOKENS: float = 0.0
    RAG_FINAL_CONTEXT_K: int = 8
    RAG_CONTEXT_MAX_TOKENS: int = 6000
    RAG_CHAT_INPUT_PRICE_PER_MILLION_TOKENS: float = 0.0
    RAG_CHAT_OUTPUT_PRICE_PER_MILLION_TOKENS: float = 0.0
    RAG_QUERY_MODE_DEFAULT: Literal['basic', 'agentic', 'auto'] = 'auto'
    RAG_AGENT_MAX_SUBQUERIES: int = 3
    RAG_AGENT_MAX_TOOL_CALLS: int = 6
    RAG_AGENT_MAX_RETRIEVAL_ROUNDS: int = 2
    RAG_AGENT_MAX_REPAIRS: int = 1
    RAG_AGENT_TIMEOUT_SECONDS: int = 30
    RAG_AGENT_MAX_TOTAL_TOKENS: int = 16000
